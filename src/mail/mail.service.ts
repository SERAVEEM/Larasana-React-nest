      ...
      await this.transporter.sendMail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0a0a;color:#ccc;padding:40px 32px;border:1px solid #222">
            ...
            <p style="color:#666;line-height:1.7">Masukkan kode OTP berikut untuk memverifikasi email Anda. Berlaku <strong style="color:#c4a050">10 menit</strong>.</p>
            ...
            <p style="font-size:12px;color:#444;text-align:center">Jika Anda tidak merasa mendaftar, abaikan email ini.</p>
          </div>
        `,
      });
    } catch {
      ...
      await this.transporter.sendMail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0a0a;color:#ccc;padding:40px 32px;border:1px solid #222">
            ...
            <p>Halo, <strong style="color:#e8d5a0">${name}</strong></p>
            <p style="color:#666;line-height:1.7">Link reset password berikut berlaku <strong style="color:#c4a050">30 menit</strong>.</p>
            <div style="text-align:center;margin:32px 0">
            ...
            <p style="font-size:12px;color:#444;text-align:center">Jika tidak meminta reset password, abaikan email ini.</p>
          </div>
        `,
      });
    } catch {
