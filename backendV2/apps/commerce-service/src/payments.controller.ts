...
import { PAYMENTS_PATTERNS, AllExceptionsToRpcFilter } from '../../../libs/shared/src';
...
export class PaymentsController {
  ...
  getStatus(@Payload() data: { userId: number; orderId: number; simulate?: string }) {
    return this.paymentsService.getPaymentStatus(data.userId, data.orderId, data.simulate);
  }
